...
- (void)curtainRevealViewController:(UIViewController *)viewControllerToReveal transitionStyle:(RECurtainTransitionStyle)transitionStyle
{
    ...
    //UIImage *selfPortrait = [UIImage imageNamed:@"splash.png"];
    ...
    [UIView animateWithDuration:.75 delay:0 options:UIViewAnimationOptionCurveEaseIn animations:^{
        if (transitionStyle == RECurtainTransitionHorizontal) {
    ...
    [UIView animateWithDuration:.75 delay:0.5 options:UIViewAnimationOptionCurveEaseIn animations:^{
